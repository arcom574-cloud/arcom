...
const navItems = [
  ...
  { icon: '👥', key: 'leads' as const, href: '/crm/leads', roles: ['superadmin', 'admin', 'sales'] },
  { icon: '📋', key: 'pipeline' as const, href: '/crm/pipeline', roles: ['admin', 'sales'] },
  { icon: '🏢', key: 'units' as const, href: '/crm/units', roles: ['superadmin', 'admin'] },
  { icon: '🎯', key: 'targets' as const, href: '/crm/targets', roles: ['superadmin'] },
  { icon: '🚗', key: 'visits' as const, href: '/crm/visits', roles: ['superadmin', 'admin', 'sales'] },
  ...
  { icon: '📚', key: 'knowledge' as const, href: '/crm/knowledge', roles: ['superadmin', 'admin', 'head_sales', 'sales'] },
